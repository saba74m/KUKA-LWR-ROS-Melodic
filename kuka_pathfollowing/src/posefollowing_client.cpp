...
class pose_sub
{
  ...
  pose_sub(){
    ...
    client = n.serviceClient<manipulator_pose_following::MoveToQuat>("/moveit_interface/move_to_rpy");
  ...
  manipulator_pose_following::MoveToQuat srv;  //Conncting to the "MeveQuat" file in the package
