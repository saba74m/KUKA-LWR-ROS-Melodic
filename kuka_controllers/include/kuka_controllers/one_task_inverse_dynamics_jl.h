#ifndef kuka_CONTROLLERS__ONE_TASK_INVERSE_DYNAMICS_JL_H
#define kuka_CONTROLLERS__ONE_TASK_INVERSE_DYNAMICS_JL_H
...
namespace kuka_controllers
{
	...
	public:
		...
		void command(const kuka_controllers::PoseRPY::ConstPtr &msg);
