#ifndef kuka_CONTROLLERS__MULTI_TASK_PRIORITY_INVERSE_DYNAMICS_H
#define kuka_CONTROLLERS__MULTI_TASK_PRIORITY_INVERSE_DYNAMICS_H
...
namespace kuka_controllers
{
	...
	public:
		...
		void command(const kuka_controllers::MultiPriorityTask::ConstPtr &msg);
