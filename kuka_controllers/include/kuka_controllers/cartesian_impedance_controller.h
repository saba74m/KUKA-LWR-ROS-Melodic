#ifndef KUKA_CONTROLLERS__CARTESIAN_IMPEDANCE_CONTROLLER_H
#define KUKA_CONTROLLERS__CARTESIAN_IMPEDANCE_CONTROLLER_H

// ROS added
#include <geometry_msgs/WrenchStamped.h>
#include <geometry_msgs/PoseStamped.h>
#include <kuka_controllers/Stiffness.h>
...
#include "kuka_controllers/KinematicChainControllerBase.h"

// The format of the command specification
#include "kuka_controllers/SetCartesianImpedanceCommand.h"
...
namespace kuka_controllers
{
	...
	public:
        ...
        void command(const kuka_controllers::CartesianImpedancePoint::ConstPtr &msg);
        bool command_cb(kuka_controllers::SetCartesianImpedanceCommand::Request &req, kuka_controllers::SetCartesianImpedanceCommand::Response &res);
