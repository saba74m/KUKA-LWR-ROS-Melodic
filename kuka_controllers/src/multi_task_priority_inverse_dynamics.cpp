...
#include <kuka_controllers/multi_task_priority_inverse_dynamics.h>
...
namespace kuka_controllers 
{
	...
	void MultiTaskPriorityInverseDynamics::command(const kuka_controllers::MultiPriorityTask::ConstPtr &msg)
	{
