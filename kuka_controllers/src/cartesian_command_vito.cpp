...
void gposeCallback(const kuka_controllers::PoseRPY::ConstPtr& msg) {
	...
	kuka_controllers::PoseRPY msg_right;
	kuka_controllers::PoseRPY msg_left;
...
// 				  0, 1,  0;
    ...
    pub_right = node.advertise<kuka_controllers::PoseRPY>("/right_arm/joint_impedance_controller/command", 30);
	pub_left = node.advertise<kuka_controllers::PoseRPY>("/left_arm/joint_impedance_controller/command", 30);
