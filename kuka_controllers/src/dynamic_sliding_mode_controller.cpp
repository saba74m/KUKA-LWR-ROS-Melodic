#include <kuka_controllers/dynamic_sliding_mode_controller.h>
...
PLUGINLIB_EXPORT_CLASS(kuka_controllers::DynamicSlidingModeController, controller_interface::ControllerBase)
