...
#include <kuka_controllers/computed_torque_controller.h>
...
PLUGINLIB_EXPORT_CLASS(kuka_controllers::ComputedTorqueController, controller_interface::ControllerBase)
