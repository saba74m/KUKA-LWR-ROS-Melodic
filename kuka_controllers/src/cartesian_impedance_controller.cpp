...
#include "kuka_controllers/cartesian_impedance_controller.h"
...
namespace kuka_controllers 
{
    ...
    void CartesianImpedanceController::command(const kuka_controllers::CartesianImpedancePoint::ConstPtr &msg)
    {
...
PLUGINLIB_EXPORT_CLASS(kuka_controllers::CartesianImpedanceController, controller_interface::ControllerBase)
