#include <kuka_controllers/minimum_effort_inverse_dynamics.h>
...
namespace kuka_controllers 
{
	...
	void MinimumEffortInverseDynamics::command(const kuka_controllers::MultiPriorityTask::ConstPtr &msg)
	{
		first_step_ = 1;
		cmd_flag_ = 1;	
	}
