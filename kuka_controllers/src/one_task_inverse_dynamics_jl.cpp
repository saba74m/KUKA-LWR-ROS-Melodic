#include <kuka_controllers/one_task_inverse_dynamics_jl.h>
...
namespace kuka_controllers 
{
	...
	void OneTaskInverseDynamicsJL::command(const kuka_controllers::PoseRPY::ConstPtr &msg)
	{	
...
PLUGINLIB_EXPORT_CLASS(kuka_controllers::OneTaskInverseDynamicsJL, controller_interface::ControllerBase)
