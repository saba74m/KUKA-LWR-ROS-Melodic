...
#include <kuka_controllers/dynamic_sliding_mode_controller_task_space.h>
...
PLUGINLIB_EXPORT_CLASS(kuka_controllers::DynamicSlidingModeControllerTaskSpace, controller_interface::ControllerBase)
