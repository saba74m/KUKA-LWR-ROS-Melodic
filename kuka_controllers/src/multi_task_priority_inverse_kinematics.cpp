...
#include <kuka_controllers/multi_task_priority_inverse_kinematics.h>
...
namespace kuka_controllers 
{
	...
	void MultiTaskPriorityInverseKinematics::command(const kuka_controllers::MultiPriorityTask::ConstPtr &msg)
	{
