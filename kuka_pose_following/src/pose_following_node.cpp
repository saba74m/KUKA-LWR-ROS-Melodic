...
#include "kuka_pose_following/DeltaPoseRPY.h"
...
kuka_pose_following::DeltaPoseRPY g_delta_pose;
...
kuka_pose_following::DeltaPoseRPY
calc_dpose(geometry_msgs::PoseStamped pose) {
  ...
  double dt = 0;
  kuka_pose_following::DeltaPoseRPY delta_pose;
  kuka_pose_following::DeltaPoseRPY pose_rpy, pose_rpy_last;
